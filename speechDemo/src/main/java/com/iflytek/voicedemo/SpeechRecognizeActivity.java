...
public class SpeechRecognizeActivity extends Activity implements OnClickListener {
	private static String TAG = SpeechRecognizeActivity.class.getSimpleName();
	// 语音听写对象
	private SpeechRecognizer speechRecognizer;
	// 语音听写UI
	private RecognizerDialog recognizerDialog;
	// 用HashMap存储听写结果
	private HashMap<String, String> recognizeResults = new LinkedHashMap<String, String>();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		speechRecognizer = SpeechRecognizer.createRecognizer(SpeechRecognizeActivity.this, mInitListener);
		
		// 初始化听写Dialog，如果只使用有UI听写功能，无需创建SpeechRecognizer
		// 使用UI听写功能，请根据sdk文件目录下的notice.txt,放置布局文件和图片资源
		recognizerDialog = new RecognizerDialog(SpeechRecognizeActivity.this, mInitListener);

		mSharedPreferences = getSharedPreferences(IatSettings.PREFER_NAME,
				Activity.MODE_PRIVATE);
		mToast = Toast.makeText(this, "", Toast.LENGTH_SHORT);
		etResult = ((EditText) findViewById(R.id.iat_text));
	}
	...
	private void initLayout() {
		...
		findViewById(R.id.iat_stop).setOnClickListener(SpeechRecognizeActivity.this);
		findViewById(R.id.iat_cancel).setOnClickListener(SpeechRecognizeActivity.this);
		findViewById(R.id.image_iat_set).setOnClickListener(SpeechRecognizeActivity.this);
	}
	...
	public void onClick(View view) {
		...
		case R.id.image_iat_set:
			Intent intents = new Intent(SpeechRecognizeActivity.this, IatSettings.class);
		...
		case R.id.iat_recognize:
			// 移动数据分析，收集开始听写事件
			FlowerCollector.onEvent(SpeechRecognizeActivity.this, "iat_recognize");
	...
	protected void onResume() {
		// 开放统计 移动数据统计分析
		FlowerCollector.onResume(SpeechRecognizeActivity.this);
	...
	protected void onPause() {
		...
		FlowerCollector.onPause(SpeechRecognizeActivity.this);
		super.onPause();
	}
}
