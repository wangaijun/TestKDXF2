...
public class SpeechRecognizeSettings extends PreferenceActivity implements OnPreferenceChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mVadbosPreference.getEditText().addTextChangedListener(new SettingTextWatcher(SpeechRecognizeSettings.this,mVadbosPreference,0,10000));
		
		mVadeosPreference = (EditTextPreference)findPreference("iat_vadeos_preference");
		mVadeosPreference.getEditText().addTextChangedListener(new SettingTextWatcher(SpeechRecognizeSettings.this,mVadeosPreference,0,10000));
	}
	@Override
